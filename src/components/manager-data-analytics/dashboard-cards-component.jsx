    ...
    <div className="dashboard-card-row">
      ...
      <div className="dashboard-card-columns">
        <div className="dashboard-card-cards cards-color-meeting-counselor">
          <FontAwesomeIcon
            ...
            className="users-cards"
          ></FontAwesomeIcon>
          <h3 style={{ fontSize: "1.6rem" }}>Meeting Counselor</h3>
          <p className="show-data-cards">
            {payload.numHasCounselorAppointment}
          </p>
        </div>
      </div>
      ...
      <div className="dashboard-card-columns">
        <div className="dashboard-card-cards cards-color-meeting-doctor">
          ...
          <p className="show-data-cards">
            {payload.numHasDoctorAppointment}
            <span>({payload.numInProcessingDoctorAppointment})</span>
          </p>
        </div>
      </div>
    </div>
