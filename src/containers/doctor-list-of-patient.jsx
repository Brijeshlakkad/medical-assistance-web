...
import { fetchPatientList, onLoadDoctorPage, rejectPatient } from '../store/actions/doctor';
...
export default function DoctorLOP(props) {
    ...
    const rejectPatientState = useSelector(state => state.doctor.rejectPatientRequestState);

    const rejectPatientErrorMessage = useSelector(state => state.doctor.rejectPatientErrorMessage);
